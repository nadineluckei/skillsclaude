...
1. **Hook (0-3s)** — a frase mais provocativa do artigo, quase sempre a
   `Tese` da pauta ou a `Narrativa comum` invertida como pergunta retórica.
   Aparece como texto na tela E como primeira fala.
...
5. **Tese / Insight (35-50s)** — a frase de efeito que resume a virada de
   perspectiva. É o momento mais "salvável"/citável do vídeo.
6. **CTA de posicionamento (50-60s)** — convite a comentar, salvar ou
...
curtos de 15-20s cortam direto do Hook para a Tese, sem Prova).
